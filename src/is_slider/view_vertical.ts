...
class View_vertical {
  ...
  _move_element_single = (e: MouseEvent) => {
    if (this._step >= 2) {
      ...
      if (e.clientY > this.parent_width + this.parent_position_x) {
        ...
        this.slider_single.style.top =
          e.clientY - this.parent_position_x - this.slider_1_width / 2 + 'px';
      }
      this.refresh_positions();
  ...
  _move_element_1 = (e: MouseEvent) => {
    ...
    if (this._step >= 2) {
      ...
      if (
        ...
        e.clientY + this.slider_1_width / 2
      ) {
        this.slider_1.style.top =
  ...
  _math__sliders_value_single(pixel_step: number, e: MouseEvent) {
    ...
    this.value_field_single.style.top =
      this._slider_single_position_left_x_axis + 'px';
  }
  ...
  _math__sliders_value_left() {
    ...
    this.value_field_1_fly.style.top =
      this.slider_1_position_left_x_axis -
      this.slider_1.offsetHeight / 2 +
      'px';
  }
  ...
  _math__sliders_value_right(e: MouseEvent) {
    ...
    this.value_field_2_fly.style.top =
      this.slider_2_position_left_x_axis +
      this.slider_2.offsetHeight / 2 +
      'px';
  }
  ...
  _math__sliders_value_single_step(steps: number, e: MouseEvent) {
    ...
    if (
      e.clientY > this.parent_position_x &&
      e.clientY + this.slider_single_width <
  ...
  _math__sliders_value_left_step(
    ...
    if (
      e.clientY <=
        this.slider_2_position_left_x_axis +
          this.parent_position.top -
          pixel_step &&
      e.clientY >= this.parent_position.top
    ) {
      this.value_field_1_fly.innerText = answer1 + ' ' + this._sign;
  ...
  _math__sliders_value_right_step(
    ...
    if (
      e.clientY < this.parent_width + this.parent_position_x &&
      e.clientY >=
    ...
    if (
      this.value_field_2_fly.offsetTop <=
      this.value_field_1_fly.offsetTop + this.slider_2.offsetHeight
    ) {
      this.value_field_2_fly.style.top =
        this.value_field_1_fly.offsetTop +
        this.slider_2.offsetHeight * 2 +
        'px';
    }
  }
  ...
  _step_implementation(
    ...
    if (static_object) {
      ...
      if (modified_object_position < static_object_position) {
        if (
          e.clientY > static_object_position + this.parent_position_x &&
          e.clientY > this.parent_position_x + pixel_step
        ) {
          modified_object.style.top =
      ...
      if (e.clientY < this.parent_position_x) {
        ...
        e.clientY > this.parent_position_x &&
        e.clientY < this.parent_position_x + this.parent_width
      ) {
        modified_object.style.top = pixel_step * step + 'px';
      }
      this.refresh_positions();
