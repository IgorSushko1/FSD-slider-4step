...
class View_horizontal {
	...
	create_this_sliders_elements = () => {
		...
		if (this._slider_type == "double") {
			...
			this.value_field_1_fly = this.parent_element.querySelector("#iss__double_fly-value-1") as HTMLElement;
			this.value_field_2_fly = this.parent_element.querySelector("#iss__double_fly-value-2") as HTMLElement;

			this.slider_1 = this.parent_element.querySelector("#iss__double_1_horizontal") as HTMLElement;
			this.slider_1_width = this.slider_1.offsetWidth;

			this.slider_2 = this.parent_element.querySelector("#iss__double_2_horizontal") as HTMLElement;
